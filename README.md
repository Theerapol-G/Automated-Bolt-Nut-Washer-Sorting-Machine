...
│  Separates bolts    │──► Bolts → Station 2
│  from nuts/washers  │──► Nuts  → Station 3
└─────────────────────┘
         │
    ┌────┴────┐
    ▼         ▼
...
└────────┘
    ...
    ▼
┌──────────────────┐
│   Station 4      │  Magnetic Conveyor
│  Sorts bolts     │──► M3 / M4 / M5 bins
│  M3 / M4 / M5   │
└──────────────────┘
         │
         ▼
┌──────────────────┐
│  Dashboard       │  TFT Display (LVGL)
│  Real-time count │
└──────────────────┘
```
...
| Name | Student ID |
|------|-----------|
| Chanaprachpakorn Ngernmo | 6530340050 |
| Theerapol Guanmuangtai | 6530340173 |
| Thanakrit Wongkha | 6530340157 |
| Warut Tongrung | 6530340254 |
| Norawich Lorttrakanont | 6530340190 |
| Kunasin Laysak | 6530340025 |
| Danuphat Parnpradit | 6530340131 |
| Thanakon Chaichana | 6530340149 |
| Jerich Brylle Sison | 6530340033 |
| Sajakorn Chutikarnmongkol | 6530340351 |
